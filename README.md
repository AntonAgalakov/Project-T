...
<span style="color:red">Обратите внимание, что в запросах для определения трудозатрат (works, intervals_works, work_time) на данный момент дата пишется в обратном порядке (yyyy-MM-dd). Вскоре будет исправлено.</span>
